...
public class Water extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Calcular Água");

        jLabel1.setBackground(new java.awt.Color(255, 255, 255));
        jLabel1.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(153, 0, 102));
        jLabel1.setText("Quanta água preciso beber?");
        jLabel1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));

        jLabel2.setText("Meu Peso:");

        botaoResultado.setText("Resulado:");
    ...
    private void botaoResultadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoResultadoActionPerformed
       ...
       double litros = calcLitros();
       String messagem = String.format("deverá beber %.1f(L) de água diários", litros);
        JOptionPane.showMessageDialog(this, messagem);
        
        
    }//GEN-LAST:event_botaoResultadoActionPerformed
    private double calcLitros(double peso){
         
        return peso/10*0.4;
    }
    private double calcLitros(){
         double peso = Double.parseDouble( jTextField1.getText());
         return peso/10*0.4;
    }
